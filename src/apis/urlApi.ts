import { AttendanceRequestDto } from 'types/request';
...
<<<<<<< HEAD
  ...
  getEvaluate:(classId:number|null,sem:string):Promise<IResponse<any>> => {
    return mainAxios.get(`${URL.GET_EVALUATE}?schoolYearClassId=${classId}&sem=${sem}`);
  },
